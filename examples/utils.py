...
def plot(
    ...
    **kwargs
    ...
    plt.scatter(x[:-1200, 0], x[:-1200, 1], s=0.2,alpha=0.2,c=point_colors[:-1200])
    # plt.scatter(x[-400:, 0], x[-400:, 1], marker="*",s=5,alpha=1,c=point_colors[-400:])
    plt.scatter(x[myfrom:myto, 0], x[myfrom:myto, 1], marker="*",s=50,alpha=1,c=point_colors[myfrom:myto])
    # Plot mediods
    if draw_centers:
        centers = []
        for yi in classes:
    ...
    img_save_path= f"/home/dd/DL/DataDistillation/Acc-DD/Visualize/cifar10/conv3in_cut_seed_2023_lr_0.01_aug_color_crop_cutout/Vis_tsne_{str(myfrom)}.pdf"
